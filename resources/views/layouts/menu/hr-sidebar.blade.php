    ...
    <ul class="side-menu">
      ...
      @canany(['gallery_list'])
        <li class="slide">
          ...
          <ul class="slide-menu">
            @can('gallery_list')
              <li><a href="{{route('admin.galleries.index')}}" class="slide-item">تصاویر/ویدئو</a></li>
            @endcan
          </ul>
        </li>
      @endcan
      ...
      @canany(['car_brand_list','car_pic_list','car_list','car_option_list','car_cat_list'])
        <li class="slide">
          <a class="side-menu__item" data-toggle="slide" href="#">
            ...
            <span class="side-menu__label">خودرو</span><i class="angle fa fa-angle-left"></i>
          </a>
          <ul class="slide-menu">
            @can('car_brand_list')
      ...
      @endcan
      @canany(['brand_list','profile_list','seen_list','slider_list','meta_list','about_list','contact_list','upload_list','setting_list','select_list','crm_lang_list','lang_set_list','site_word_list'])
        <li class="slide">
          <a class="side-menu__item" data-toggle="slide" href="#">
          ...
          <ul class="slide-menu">
            ...
            @endcan
            @can('navbar_list')
              <li><a href="{{route('admin.navbar.index')}}" class="slide-item">نوبار</a></li>
            @endcan
            @can('profile_list')
            ...
            @endcan
            @can('brand_list')
              <li><a href="{{route('admin.brand.index')}}" class="slide-item">برندها</a></li>
            @endcan
            @can('meta_list')
