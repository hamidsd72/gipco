            ...
            <div class="card">
                <div class="card-header  border-0">
                    <h4 class="w-100">
                        {{$title}}
                        @can('brand_create')
                        <a href="{{route('admin.brand.create')}}" class="btn btn-primary float-left">افزودن</a>
                        @endcan
                    </h4>
                </div>
...
{{--                                            <a href="{{route('admin.brand.status',[$item->id,'status','pending'])}}">--}}
{{--                                                <i class="fa fa-close text-danger"></i>--}}
{{--                                            </a>--}}
{{--                                        @else--}}
{{--                                            <span class="text-danger ml-1">عدم انتشار</span>--}}
{{--                                            <a href="{{route('admin.brand.status',[$item->id,'status','active'])}}">--}}
                                    ...
                                    @canany(['brand_edit','brand_delete'])
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                @endcan
                                                    @can('brand_delete')
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['admin.brand.destroy', $item->id] ]) !!}
