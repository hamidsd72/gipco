    ...
    <div class="row mt-5">
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::model($item,array('route' => array('admin.brand.update',$item->id),'id'=>'form_req', 'method' => 'PATCH','files'=>true)) }}
                                ...
                                <div class="tab-pane fade {{$lang->align=='ltr'?'ltr_tab':''}}" id="nav-{{$lang->lang}}" role="tabpanel" aria-labelledby="nav-{{$lang->lang}}-tab">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    {{Form::label('title1_'.$lang->lang, 'عنوان ')}}
